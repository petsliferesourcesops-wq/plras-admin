...
function getAdminHTML(data, reviewSecret) {
  ...
  const cards = documents.map((doc) => {
    ...
    return `
\xA0 \xA0 \xA0 <div class="card">

\xA0 \xA0 \xA0 \xA0 <div class="row">
\xA0 \xA0 \xA0 \xA0 \xA0 <h3>${name}</h3>

\xA0 \xA0 \xA0 \xA0 \xA0 <span class="badge ${status}">
\xA0 \xA0 \xA0 \xA0 \xA0 \xA0 ${status}
\xA0 \xA0 \xA0 \xA0 \xA0 </span>
\xA0 \xA0 \xA0 \xA0 </div>

\xA0 \xA0 \xA0 \xA0 <p>
\xA0 \xA0 \xA0 \xA0 \xA0 <b>ID:</b>
\xA0 \xA0 \xA0 \xA0 \xA0 ${submissionId}
\xA0 \xA0 \xA0 \xA0 </p>

\xA0 \xA0 \xA0 \xA0 <p>
\xA0 \xA0 \xA0 \xA0 \xA0 <b>Role:</b>
\xA0 \xA0 \xA0 \xA0 \xA0 ${role}
\xA0 \xA0 \xA0 \xA0 </p>

\xA0 \xA0 \xA0 \xA0 <p>
\xA0 \xA0 \xA0 \xA0 \xA0 <b>Email:</b>
\xA0 \xA0 \xA0 \xA0 \xA0 ${email}
\xA0 \xA0 \xA0 \xA0 </p>

\xA0 \xA0 \xA0 \xA0 <p>
\xA0 \xA0 \xA0 \xA0 \xA0 <b>Score:</b>
\xA0 \xA0 \xA0 \xA0 \xA0 ${score2}
\xA0 \xA0 \xA0 \xA0 </p>

\xA0 \xA0 \xA0 \xA0 <p>
\xA0 \xA0 \xA0 \xA0 \xA0 <b>Created:</b>
\xA0 \xA0 \xA0 \xA0 \xA0 ${created}
\xA0 \xA0 \xA0 \xA0 </p>

\xA0 \xA0 \xA0 \xA0 <div class="actions">

\xA0 \xA0 \xA0 \xA0 \xA0 <a
\xA0 \xA0 \xA0 \xA0 \xA0 \xA0 class="approve"
\xA0 \xA0 \xA0 \xA0 \xA0 \xA0 href="/review?id=${submissionId}&action=approved&role=${role}&secret=${reviewSecret}"
\xA0 \xA0 \xA0 \xA0 \xA0 >
\xA0 \xA0 \xA0 \xA0 \xA0 \xA0 Approve
\xA0 \xA0 \xA0 \xA0 \xA0 </a>

\xA0 \xA0 \xA0 \xA0 \xA0 <a
\xA0 \xA0 \xA0 \xA0 \xA0 \xA0 class="reject"
\xA0 \xA0 \xA0 \xA0 \xA0 \xA0 href="/review?id=${submissionId}&action=rejected&role=${role}&secret=${reviewSecret}"
\xA0 \xA0 \xA0 \xA0 \xA0 >
\xA0 \xA0 \xA0 \xA0 \xA0 \xA0 Reject
\xA0 \xA0 \xA0 \xA0 \xA0 </a>
...
body{
\xA0 font-family:Arial;
\xA0 background:#f3f4f6;
\xA0 padding:30px;
}

h1{
\xA0 margin-bottom:20px;
}
...
\xA0 padding:12px;
\xA0 width:300px;
\xA0 border-radius:8px;
\xA0 border:1px solid #ddd;
}

button{
\xA0 padding:12px 18px;
\xA0 border:none;
\xA0 border-radius:8px;
\xA0 cursor:pointer;
}
...
.reload{
\xA0 background:#2563eb;
\xA0 color:white;
}

.logout{
\xA0 background:#dc2626;
\xA0 color:white;
}
...
.card{
\xA0 background:white;
\xA0 padding:20px;
\xA0 border-radius:14px;
\xA0 box-shadow:
\xA0 \xA0 0 2px 8px rgba(0,0,0,0.08);
}

.row{
\xA0 display:flex;
\xA0 justify-content:space-between;
\xA0 align-items:center;
}

.badge{
\xA0 padding:6px 10px;
\xA0 border-radius:999px;
\xA0 color:white;
\xA0 font-size:12px;
}

.pending{
\xA0 background:#f59e0b;
}

.approved{
\xA0 background:#10b981;
}

.rejected{
\xA0 background:#ef4444;
}
...
\xA0 await fetch("/logout");

\xA0 location.href="/login";
}
...
// .wrangler/tmp/bundle-W6Vd9E/middleware-insertion-facade.js
...
// .wrangler/tmp/bundle-W6Vd9E/middleware-loader.entry.ts
